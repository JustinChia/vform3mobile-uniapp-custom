  ...
  <view clipchildren="false">
    ...
    <view
      ...
      <view class="fj-value">
        <text
          class="fj-v-l"
          :style="{ color: showMinNum === fillMinValue ? '#333' : '#999' }"
          >{{ fillMinValue }}</text
        >
        <text
          class="fj-v-r"
          :style="{ color: showMaxNum === fillValue ? '#333' : '#999' }"
          >{{ fillValue }}</text
        >
      </view>
      <text
        class="tip"
        :style="{ left: `${tipLeft}px`, opacity: tipShow ? '1' : '0' }"
        >{{ curValue }}</text
      >
      <view
        class="fj-slider"
        ...
        <view
          class="fj-line"
          ref="fj-line"
          :style="{top: `${blockSize/2}px`}"></view>
        <view
          v-if="maxLeft - minLeft >= 0"
          class="fj-line-pull"
          :style="{ left: `${minLeft + touchWidth / 2}px`, width: `${Math.abs(maxLeft - minLeft)}px`,top: `${blockSize/2}px` } "></view>
        <view
          v-else
          class="fj-line-pull"
          :style="{ left: `${minLeft + touchWidth / 2 - Math.abs(maxLeft - minLeft)}px`, width: `${Math.abs(maxLeft - minLeft)}px`,top: `${blockSize/2}px` }"></view>
        <view
          class="fj-touch-left"
          ref="fjtouchleft"
          ...
          :style="{ left: `${minLeft}px`, height: `${blockSize}px`, width: `${blockSize}px`}">
        </view>
        <view
          ...
          :style="{ left: `${maxLeft}px`, height: `${blockSize}px`, width: `${blockSize}px` }">
        </view>
      </view>
    </view>
  </view>
